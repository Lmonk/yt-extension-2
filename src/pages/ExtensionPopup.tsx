...
function ExtensionPopup() {
  ...
  const openNewTab = async () => {
    chrome.tabs.create({
      url: chrome.runtime.getURL("index.html#/statistic-page"),
    });
  };
      ...
      <div className="container mx-auto py-4">
        <div className="flex flex-col">
          <div className="px-4">
            <div className="flex justify-between mb-2">
              ...
              <div className="flex flex-row">
                ...
                <div
                  className="w-5 h-6 fill-white hover:opacity-60 cursor-pointer"
                  onClick={() => openNewTab()}
                >
                  <ProfileIcon />
                </div>
          ...
          <SimpleBar className="videos-container">
            <div className="text-lg font-semibold text-white p-2 mb-2">
              Active videos:
            </div>
