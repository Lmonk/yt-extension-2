...
function loadImage (src) {
    return new Promise((resolve, reject) => {
      ...
      image.crossOrigin = "Anonymous"; // Анонімний запит для обходу проблем з CORS
      image.src = src;
    })
}
 ...
 * @return {{r: number, g: number, b: number}}
 */
const getColor = (sourceImage, quality) => {
 ...
 */
const getPaletteFromURL = async (URL, colorCount, quality) => {
 ...
 * @return {Promise<{r: number, g: number, b: number}>}
 */
const getColorFromURL = async (imageURL, quality) => {
